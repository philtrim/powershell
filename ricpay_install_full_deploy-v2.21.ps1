...
function inst-ricpay-local
    
  {
   ...
   # _______________________________________________________________________________________________________________
    ...
    Start-Process msiexec.exe -passthru -Argumentlist '/i c:\disk1\pstwain\ext\psip_twain.msi /qn /norestart'
   ...
   # _______________________________________________________________________________________________________________
    ...
    #Start-Process msiexec.exe -passthru -Argumentlist '/i "$inst\RICPAY\ScandAll\ScandAll 2.0.11\SDATA1\setup_en.msi" /qn /norestart'
    Start-Process msiexec.exe -passthru -Argumentlist '/i c:\source\setup_en.msi /qn /norestart'
...
function global:inst-ricpay-remote
  ...
  if (Test-Connection -Cn $computer -BufferSize 16 -Count 1 -ea 0 -quiet)
   ...
   # _______________________________________________________________________________________________________________
    ...
    invoke-command -cn $computer {Start-Process msiexec.exe -passthru -ArgumentList '/i c:\disk1\pstwain\ext\psip_twain.msi /qn /norestart'}
   ...
   # _______________________________________________________________________________________________________________
    ...
    invoke-command -cn $computer {Start-Process msiexec.exe -PassThru -ArgumentList '/i c:\source\setup_en.msi /qn /norestart'}
